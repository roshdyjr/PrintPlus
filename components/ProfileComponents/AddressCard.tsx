  ...
  return (
    <div className="border border-[#E2E8F0] bg-[#FAFDFF] rounded-[12px] p-4 shadow-sm flex flex-col gap-2 xlg:p-6 xlg:gap-[9px]">
      ...
      <div className="flex items-center gap-4">
        <button className="font-medium hover:underline xlg:text-[20px] xlg:font-medium">Edit</button>
        <span className="inline-block w-[2px] h-4 bg-[#E2E8F0]" />
        <button className="text-[#BE123C] font-medium hover:underline xlg:text-[20px] xlg:font-medium">Remove</button>
      </div>
    </div>
  );
};
