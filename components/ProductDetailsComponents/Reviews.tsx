...
export default function Reviews() {
  ...
  return (
    <div className="mx-auto flex flex-col py-4 px-4 mt-0 gap-4 max-w-[1920px] lg:px-[71.55px] lg:mt-[71.55px] xlg:gap-6">
      <h2 className="text-xl font-semibold xlg:text-[30px]">Most recent reviews</h2>
      <div className="flex flex-col gap-[6px] items-center w-[120px] xlg:w-[233px]">
        <div className="flex items-center gap-2">
          <Star
            className="text-[#6366F1] w-[20px] h-[19px] xlg:w-[35px] xlg:h-[35px]"
            fill="currentColor"
          />
          <span className="text-lg font-semibold xlg:text-[38px]">4.8/5.0</span>
        </div>

        <p className="text-[#A6A6A6] text-sm xlg:text-[20px]">
          50 Reviews
        </p>
      </div>
